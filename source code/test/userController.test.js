...
describe("The UserController should", () => {
    ...
    it("should getAllUserData",  (done) => {
        ...
        let res = {
            ...
            send: function(value){
                console.log(value);
                expect(value.user.email).toBe("andre@phiquest.io");
                expect(value.groups[0].group.group_name).toBe("PhiquestBest");
                done();
                return this
            }
        };
        auth(req,res,UserController.getAllUserData);
    });
    it("should getAllUserAccounts", (done) => {
        let req =
            {
            }
        let res = {
        ...
        UserController.getAllUserAccounts(req, res);
    });
    it("should addUserFromDashboard", (done) => {
        ...
        UserController.addUserFromDashboard(req, res);
    });
    ...
    it("should editUserFromDashboard", (done) => {
        ...
        UserController.editUserFromDashboard(req, res);
    });
    it("should deleteUserFromDashboard", (done) => {
        ...
        UserController.deleteUserFromDashboard(req, res);
    });
    it("should getTokenOfUser", (done) => {
        let req =
            {
                body:
                    {
                        email: "allenc4537@gmail.com"
                    }
            }
        let res = {
            status: function (value) {
        ...
        UserController.getTokenOfUser(req, res);
    });
    it("should getUserIdWithEmail", (done) => {
        let req =
            {
                body:
                    {
        ...
        UserController.getUserIdWithEmail(req, res);
    });
});
